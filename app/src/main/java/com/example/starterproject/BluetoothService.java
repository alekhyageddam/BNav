...
//    private final IBinder mBinder = new BluetoothBinder();
    ...
    private static final UUID MY_UUID = UUID.fromString("00001101-0000-1000-8000-0006664F9479");
    ...
    public void onCreate()
    {
        ...
        if (pairedDevices.size() > 0) {
            ...
            for (BluetoothDevice device : pairedDevices) {
                ...
                if(deviceName.contains("FireFly-9479")) {
                    Log.v("TEST","Connecting to bluesmirf");
                    connect(device);
                    break;
                }
            }
